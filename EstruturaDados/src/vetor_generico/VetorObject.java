...
public class VetorObject {
	//ATRIBUTOS
	private Object vetor[]; //Não estou declarando o tamanho do vetor
	protected int cont;  //variavel de controle do vetor
	
	//CONTRUTOR DA CLASSE VETOR
	public VetorObject (int tamanho) { //Recebendo o tamanho do vetor como parmetro
	...
	private void aumentarCapacidade() {
		if (this.cont == this.vetor.length) {
			Object vetorAux[] = new Object[vetor.length * 2]; //Criando um vetor com o dobro do tamanho
	...
	public boolean adicionar(Object string, int pos) throws Exception{
		aumentarCapacidade();
	...
	public Object buscarElemento (int pos) throws IllegalArgumentException{
	...
	public int buscarElemento (Object palavra) {
	...
	public boolean remover (Object palavra) {
